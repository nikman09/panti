...
$pdf->SetTitle('Laporan Daftar Klien');
...
$title = '<h3>DAFTAR NAMA KLIEN
</h3>';
$pdf->WriteHTMLCell(0, 0, '', '',$title, 0, 1, 0, true, 'C', true);
$table ='
        <table border="1px" cellspacing="0" border-color="#000" cellpadding="4">
     
            <tr >
                <td align="center" width="35px"><b>NO</b></td>
                <td align="center"><b>NAMA</b></td>
                <td align="center" width="150px"><b>UMUR/TTL</b></td>
                <td align="center" width="90px"><b>PROGRAM</b></td>
                <td align="center" width="150px"><b>ALAMAT</b></td>	
                <td align="center"><b>ASAL DAERAH</b></td>
            </tr>
         ...
         ';
           ...
           foreach ($data as $row) {
                ...
                $table.= "<td>".  $diff->y." Tahun / ".$row->tempat_lahir.",".tgl_indo($row->tanggal_lahir)."</td>";
                $table.= "<td>".$row->rombel."</td>";
                $table.= "<td>".$row->alamat."</td>";
                $table.= "<td>".$row->kota."</td></tr>";
           }
