...
class TCPDF {
	 ...
	 * @public
	 */
	public function setHeaderData($lg ='', $ln='', $lw=0, $ht='', $hs='', $tc=array(0,0,0), $lc=array(0,0,0)) {
		$this->header_logo = $ln;
	...
	public function getHeaderData() {
		...
		$ret['tengah'] = $this->header_logo_tengah;
		return $ret;
	}
		...
		if ($this->header_xobjid === false) {
			...
			if (($headerdata['logo']) AND ($headerdata['logo'] != K_BLANK_IMAGE)) {
				...
				if (($imgtype == 'eps') OR ($imgtype == 'ai')) {
					...
					$this->Image(K_PATH_IMAGES.$headerdata['logo'], $headerdata['tengah'], '', $headerdata['logo_width']);
				}
